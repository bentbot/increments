...
exports.countVotes = function (poll, cb) {
    ...
    // Async finish...
        ...
        if ( engine == 'mysql' ) {
            ...
            async.each(candidates[poll], function(candidate) {
                candidateKeys.push(candidate.id + " = 1");
            });
            let joinedCandidates = candidateKeys.join();
            // console.log("SELECT COUNT(*) FROM "+poll, joinedCandidates);
            // TODO: Change MySQL count to be generated from candidate names instead of globally
