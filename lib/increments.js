                        ...
                        **/ 
                        ...
                        if ( structure.length > -1 ) {
                            ...
                            for (var i = structure.length - 1; i >= 0; i--) {
                                let suffex = 'AFTER '+candidates[poll][candidates.length].id;
                                console.log(candidates.length, candidates[poll][candidates.length])
            ...
            mysql.query("SELECT COUNT(*) FROM " + poll + " WHERE " + condition, function (err, count) {
                ...
                async.each( statistics, function ( statistic ) {
                    ...
                    if (statistic.count > 0) {
                        ...
                        statistic.percentage = Math.round(statistic.percentage*100);
                    }
