...
exports.setup = function (data, cb) {
    ...
    percentageInt = data.roundMode?data.roundMode:'floor';
                        ...
                        **/ 
                        ...
                        if ( structure.length > -1 ) {
                            ...
                            if ( rules.length > 0 ) {
                                ...
                                mysql.query(query + poll + rules, function(err, results) {
    ...
    // Async finish...
        ...
        if ( engine == 'mysql' ) {
            ...
            mysql.query("SELECT COUNT(*) FROM " + poll + " WHERE " + condition, function (err, count) {
                ...
                // TODO: fix TypeError: this.calculateVotes is not a function
                ...
                async.each( statistics, function ( statistic ) {
                    ...
                    if (statistic.count > 0) {
                        ...
                        if ( percentageInt == 'floor' ) statistic.percentage = Math.floor(statistic.percentage*100);
                        if ( percentageInt == 'float' ) statistic.percentage = float(statistic.percentage*100);
                        if ( percentageInt == 'round' ) statistic.percentage = Math.round(statistic.percentage*100);
                        if ( percentageInt == 'pure' ) statistic.percentage = statistic.percentage*100;
                    }
...
// Calculate percentages for vote candidates
